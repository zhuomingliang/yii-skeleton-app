...
<?php echo "<?php echo Html::beginForm(); ?>\n"; ?>

<?php echo "<?php echo Html::errorSummary(\$model); ?>\n"; ?>
...
<div class="action">
<?php echo "<?php echo Html::submitButton(\$update ? 'Save' : 'Create'); ?>\n"; ?>
</div>

<?php echo "<?php echo Html::endForm(); ?>\n"; ?>

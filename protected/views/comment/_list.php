...
<div class="comment" id="c<?php echo $comment->id; ?>">
	...
	<?php if (Yii::app()->user->hasAuth(Group::ADMIN)) echo ' | '.Html::linkButton('delete', array('submit'=>array('comment/delete', 'id'=>$comment->id),
	'confirm'=>"Are you sure to delete comment #{$comment->id}?",
	));?>
	 - <?php echo Html::link('Permalink',array('post/show','id'=>isset($post)?$post->id:$comment->post->id,'#'=>'c'.$comment->id),array(
		'class'=>'permalink',
